          ...
          <div className='flex flex-col items-center text-center'>
            <div className='relative mb-4'>
              <div className='w-20 h-20 rounded-full border-2 border-primary-fixed overflow-hidden'>
                <img alt='Lead Dispatcher' data-alt='professional dispatcher avatar portrait in profile view' src='https://lh3.googleusercontent.com/aida-public/AB6AXuAiNcejvhFrwIphPH64a-ObZsuTwri3WB12DpMWl3WU1uYk8imF7gyONqcFffpiybFtZ-QCb-w4JNORIz0gSIrI8uvX4ZJ1bNOoz8C0y0ScEBfC5CyjiHUL3ClTYHGSn71BkABEFSdMXKq8NkrWYJegn2Bpfvq_avm2QxnRr6nrdfYMYMR7-rnmiywgNHb20nnKKYtB86I17pIEuAyVzT2V9EyJi5V7sk9RDhFgPPj0trKayKwZb7QKAWUW-lkMq2mPF7NJOHJvQxh'/>
              </div>
