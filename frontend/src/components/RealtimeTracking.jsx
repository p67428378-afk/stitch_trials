    ...
    <section className='flex-shrink-0 w-[1200px] space-y-8'>
      ...
      <div className='flex gap-6 h-[550px]'>
        ...
        <div className='flex-1 bg-surface-container-low rounded-xl relative overflow-hidden'>
          <div className='absolute inset-0 grayscale contrast-125 opacity-40 mix-blend-multiply bg-cover bg-center' data-alt='minimalist city map schematic with clean vector lines and muted tones' data-location='London' style={{ backgroundImage: 'url(\'https://lh3.googleusercontent.com/aida-public/AB6AXuBRycORSDfSGr_oYQpJAqSbET7ivVKUfIlJZK-mtz3MfhCTpRj_VhSPV3S_WmPft1yhqKVP3ipbj962nEyhnHeI-yDlrfthotIXUKoGyxF8AjjvEZAkBlwo1LswGb9GTHbyAAe9Ni_oIy5nNmEtBjz6SBQSeVGVyh1haUO6796jUon889fIv343ibr4HH-W6GB9X0cEtQKTL5OP1HMwIGbPeo246YDPdf29mi1tJxB0djo33-yVt9ynIlflPsVeCCpSPa2IKuUXvNKZ\')' }}></div>
